...
first_training_end_index = full_backtesting_data.index[
    full_backtesting_data["Time"] == backtest_start_date_time
].tolist()[0]
final_training_end_index = full_backtesting_data.index[
    full_backtesting_data["Time"] == backtest_end_date_time
].tolist()[0]
...
for training_end_point in range(first_training_end_index, final_training_end_index + 1):
    ...
    training_df = full_backtesting_data.iloc[
        training_start_point : training_end_point + 1
    ]
