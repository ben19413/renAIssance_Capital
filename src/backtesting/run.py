...
filtered_backtesting_data = full_backtesting_data.loc[backtest_start_date_time:backtest_end_date_time]
for training_end_point in filtered_backtesting_data.index:

    training_start_point = training_end_point - timedelta(hours = training_period_data_size)
